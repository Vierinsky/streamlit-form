...
def cargar_lista(nombre_hoja, columna):
    ...
    Usa caché para evitar múltiples lecturas y reducir llamadas a la API de Google Sheets.
...
# Entrada para descripción y valor bruto
...
def fecha_vencimiento_input(dias):
    """
    Genera un campo de entrada para vencimiento con tres opciones.
    Si se elige establecer fecha, propone como default hoy + días.

    Args:
        dias (int): Días a sumar desde hoy para la fecha sugerida.

    Returns:
        str: Fecha en formato "dd/mm/yyyy" o un texto ('Por definir', 'N/A')
    """
...
# Selector de forma de pago asociada a un vencimiento
...
# Entradas para los 4 vencimientos estándar
